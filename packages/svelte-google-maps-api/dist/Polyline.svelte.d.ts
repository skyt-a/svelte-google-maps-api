...
declare const Polyline: $$__sveltets_2_IsomorphicComponent<{
    [x: string]: any;
    path?: (google.maps.LatLng | google.maps.LatLngLiteral)[] | google.maps.MVCArray<google.maps.LatLng> | undefined;
    ...
    onPathChanged?: ((newPath: google.maps.MVCArray<google.maps.LatLng>) => void) | undefined | undefined;
    onLoad?: ((polyline: google.maps.Polyline) => void) | undefined | undefined;
    onUnmount?: ((polyline: google.maps.Polyline) => void) | undefined | undefined;
}, {
    [evt: string]: CustomEvent<any>;
}, {}, {}, string>;
type Polyline = InstanceType<typeof Polyline>;
export default Polyline;
//# sourceMappingURL=Polyline.svelte.d.ts.map